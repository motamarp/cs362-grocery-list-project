  ...
  return (
    <div>
      ...
      <div className="panel">
        ...
        ) : selectedList.items_by_store ? (
          // Grouped by store (new backend feature)
          Object.entries(selectedList.items_by_store).map(([storeName, storeItems]) => (
        ...
        selectedList.items?.length ? (
          selectedList.items.map(item => renderItem(item))
         ) : (
