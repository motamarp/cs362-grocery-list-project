...
- I learned how to use a scraper and integrate it into websites, despite the unsuccessful nature of my efforts.
- I learned more about developing frontends, specifically regarding cosmetic website features through tutorials. 
- I learned how to more coherently communicate with my team members and identify problems within their different versions of the project.
...
This was my first experience creating a project application such as this with a team. I have learned and experienced a lot of new things from learning new code frameworks to picking up new skills of working in a software engineering team. The first lesson I learned was putting in the effort and time to learn new things. Throughout my journey, I continuously get errors in my code which I don't know how to fix. The Django framework was new to me and reading the documentation often overwhelms me due to the amount of information. I often just thought about putting the learning django framework to the side and doing other things but I always try to hold myself and put in the effort to understand and fix the problem. While looking through documentation, I also watched videos tutorials explaining the Django framework. This paid off a lot as now I was able to finally create my recipe, meal plan and grocery list models and serializers and test them by using the json data and API in the Django Rest framework .This experience helped me grow as Software engineer and helped me understand on the methods of how I can learn better.

Another lesson which I found very helpful through the course of this project is communication. Communication within the team is very integral. It helps me and my teammates to inform one another on announcements, important deadlines, fixes on the code, and what implementations left that are needed for the project. Communication helps me to keep me in the loop of what things need to be done and how I can help instead of making me lost on what to do. 

The Last lesson I learn in this journey is to adapt. It is already hard for me to balance my time  
