...
One last thing I learn which I find very useful to keep with me in my career is Github. Before, Github was a website that I did not think too much of other than a place to receive my assignment. Through this course and the project, I find its tools are very helpful when it comes to working and sharing code amongst a team. Using the github branches, I can freely share my version of the project with my code edits without affecting the main project code. I learned  the github issues which act like announcements/reports on what’s going on with the code. I also like github’s pull request where I can see what changes and differences are between our codes. 
